...
use bpfanalysis::verifier_log::{
    ...
    direct_call_target_from_instruction_tail, instruction_assigns_register, instruction_frame,
    instruction_site_before_line, instructions_in_line_range, is_verifier_error_line,
    is_verifier_fragment_boundary, latest_reg_state_before, latest_reg_state_before_instruction,
    latest_reg_state_before_instruction_with_origin, latest_reg_state_for_call_argument,
    latest_reg_state_for_call_argument_with_frame, loose_register_operands as register_operands,
    ...
    scalar_range_has_any_bound, stack_value_range, terminal_instruction_site,
...
use crate::source::{
    collect_source_events, looks_like_packet_bounds_check, terminal_source, SourceEvent,
    SourceLocation,
};
...
fn proof_signals(context: ProofSignalContext<'_>) -> Vec<ProofSignal> {
    ...
    push_optional_signals!(map_value_signal::verifier_precision_signal(c), packet_verifier_precision_signal(c));
