...
use bpfanalysis::verifier_log::{
    ...
    memory_access_is_atomic, memory_access_offset, memory_access_width, parse_i64_after,
    parse_instruction_line, parse_u32_after, scalar_range_has_any_bound, scalar_ranges_match,
...
use crate::source::{
    collect_source_events, looks_like_packet_bounds_check, looks_like_scalar_guard,
    terminal_source, SourceEvent, SourceLocation,
};
