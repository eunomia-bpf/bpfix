...
C4 taxonomy routing & 系统能区分 source bug、lowering artifact 和环境/配置失败 & coarse failure-class 与 taxonomy agreement 为 211/235；lowering artifact recall 为 12/24，environment recall 为 10/11，limit recall 为 4/4 & partial \\
...
\midrule
known error id & 235/235 & 145/235 & \sys 避免 fallback/unknown，并覆盖 dynptr、environment、limit 和 lowering-pattern families \\
error-id exact & 60/235 & 43/235 & label error id 比 runtime catalog 更细，二者都偏低 \\
taxonomy agreement & 211/235 & 199/235 & \sys 利用 full-log proof/lowering signals 提升 coarse routing，但不是完整 root-cause accuracy \\
taxonomy macro-F1 & 0.695 & 0.558 & lowering artifact routing 明显改善，但 false positive 仍未建模 \\
