...
harness:
  name: bpfix-replay
  script: docs/bpfix-py/tools/validate_benchmark.py
...
14. `docs/bpfix-py/tools/validate_benchmark.py --replay bpfix-bench` succeeds for the case.
...
```
python3 docs/bpfix-py/tools/validate_benchmark.py --replay bpfix-bench
```

`docs/bpfix-py/tools/validate_benchmark.py` must rerun build/load/capture for every listed
...
1. run `docs/bpfix-py/tools/validate_benchmark.py --replay bpfix-bench`, or require a passing
