...
corpus (`bpfix-bench/splits/dev40.txt`). Raw and structured modes were run over
...
- Runner: `bpfix-bench/tools/run_suite.py`
- Temperature: `0.0`
- Max tokens: `8192`
...
- Raw local artifact:
  `/tmp/bpfix-bench-qwen27b-full-40-93f90fb-nocache/20260617T200011916619Z-pid847632/raw/summary.json`
  (`beaddcb0126547a769be689b083a4aac09570f0b0c9324568f4522ab515957db`)
- Structured local artifact:
  `/tmp/bpfix-bench-qwen27b-full-40-93f90fb-nocache/20260617T200540551769Z-pid848977/structured/summary.json`
...
- Kernel/toolchain: Linux `6.15.11-061511-generic`, clang `18.1.3`,
  bpftool `v7.7.0`, libbpf `v1.7`
- Raw local artifact:
  `/tmp/bpfix-bench-qwen27b-full-18-same-config-4433580/20260617T050654449230Z-pid64558/raw/summary.json`
  (`2aeeed7427552d17aec88e59717d06c614aa8e87be2b73db9560a67f9be542a7`)
- Structured local artifact:
  `/tmp/bpfix-bench-qwen27b-full-18-same-config-4433580/20260617T051002605195Z-pid64952/structured/summary.json`
...
- Repository dirty: `false`
- Raw local artifact:
  `/tmp/bpfix-bench-qwen27b-clean-9case-after-hint/20260617T025534108607Z-pid447889/raw/summary.json`
  (`9b9e56522f0539dba291da06714ebfac489d84e2e596d6fd0c5702f904318985`)
- Structured local artifact:
  `/tmp/bpfix-bench-qwen27b-clean-9case-after-hint/20260617T025649866414Z-pid449956/structured/summary.json`
...
- Do not claim `bpfix-bench` meets the benchmark goal until a larger admitted
...
- Raw local artifact:
  `/tmp/bpfix-bench-qwen27b-next4-oracle-tight/20260617T035110212045Z-pid33195/raw/summary.json`
  (`5f6930ab2a8a4a711384de0e1a46258c0ff5cd9e57cf6d88c586fe45d920c330`)
- Structured local artifact:
  `/tmp/bpfix-bench-qwen27b-next4-oracle-tight/20260617T035017111923Z-pid33073/structured/summary.json`
...
- Repository dirty: `true`
- Raw local artifact:
  `/tmp/bpfix-bench-qwen27b-admitted-next5-tightened-v3/20260617T044829217928Z-pid60228/raw/summary.json`
  (`ad40887fd3d0112bd19bd3decd63550fd51cb733a7716503f9cafc9e228db06b`)
- Structured local artifact:
  `/tmp/bpfix-bench-qwen27b-admitted-next5-tightened-v3/20260617T044927834654Z-pid60324/structured/summary.json`
