...
python3 bpfix-test/tools/run_suite.py \
  ...
  --expected-count 75 \
  --results-dir bpfix-test/results/raw-main-qwen36-27b-hardened2-current \
...
- raw one-shot:
  `bpfix-test/results/raw-main-qwen36-27b-hardened2-current/20260622T095443274429Z-pid2155539/raw/summary.json`
- BPFix one-shot:
  `bpfix-test/results/bpfix-main-qwen36-27b-hardened2-current/20260622T101050360741Z-pid2167585/bpfix/summary.json`
- raw retry:
  `bpfix-test/results/raw-main-qwen36-27b-hardened2-retry2-current/20260622T102327736469Z-pid2187731/raw/summary.json`
- BPFix retry:
  `bpfix-test/results/bpfix-main-qwen36-27b-hardened2-retry2-current/20260622T105116447851Z-pid2222732/bpfix/summary.json`
...
`bpfix-test/tools/bpf_case.py` now supports `source_success_predicates`. These
